...
class Varien_Simplexml_Config
{
    ...
    public function loadCache()
    {
		...
		$xml = SimpleXml_Dom_Element_Adapter::loadFromString($xmlString, $this->_elementClass);
        if ($xml) {
            $this->_xml = $xml;
    ...
    public function loadString($string)
    {
        if (is_string($string)) {
			...
			$xml = SimpleXml_Dom_Element_Adapter::loadFromString($string, $this->_elementClass);
    ...
    public function loadDom($dom)
    {
		...
		$className = $this->_elementClass;
		$xml = $className::createFromDocument($dom);
