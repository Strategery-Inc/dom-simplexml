<?php
/**
 * Override to use SimpleXml_Dom_Element_Adapter instead of SimpleXMLElement
 */
...
class Mage_Core_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    /**
     * Transform an assoc array to SimpleXml_Dom_Element_Adapter object
...
XML;
		...
		$xml = SimpleXml_Dom_Element_Adapter::loadFromString($xmlstr);
     ...
     * @param array $array
     * @param string $rootName
     * @param SimpleXml_Dom_Element_Adapter $xml
     * @return SimpleXml_Dom_Element_Adapter
     * @throws Exception
     */
    private function _assocToXml(array $array, $rootName, &$xml)
    {
        $hasNumericKey = false;
        $hasStringKey  = false;
        foreach ($array as $key => $value) {
